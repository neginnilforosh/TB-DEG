...
##
## Edit the `deg_lists` below to point at whichever comparisons you
## want on the same UpSet plot (e.g. every "vs Healthy/HC/TBneg"
## latent-TB comparison across datasets, or TB-only vs TB+comorbidity
## contrasts once those metadata fields exist).
## =============================================================
...
## Tip: once comorbidity metadata (TB-DM, TB-HIV, TB-LC, drug-resistant
## TB, etc.) is attached to each dataset's trait file, you can instead
## build one `deg_lists` entry per comorbidity contrast and re-run this
## script to get the TB-DM/TB-HIV/TB-LC-style UpSet plot referenced in
## the project brief.
